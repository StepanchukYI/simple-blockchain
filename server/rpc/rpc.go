...
func DefaultRPCDecodeFunc(rpc RPC) (*DecodedMessage, error) {
	...
	case MessageTypeTx:
		...
		if err := tx.Decode(internal.NewGobTxDecoder(bytes.NewReader(msg.Data))); err != nil {
			return nil, err
		}
	...
	case MessageTypeBlock:
		...
		if err := block.Decode(internal.NewGobBlockDecoder(bytes.NewReader(msg.Data))); err != nil {
			return nil, err
		}
